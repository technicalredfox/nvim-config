...
vim.opt.numberwidth = 2 -- set width of number column
...
vim.opt.tabstop = 4 -- number of spaces inserted for a tab character
...
vim.opt.conceallevel = 0 -- show consealed characters in markdown files
...
vim.opt.splitright = true -- force vertical splits rigth of current window
